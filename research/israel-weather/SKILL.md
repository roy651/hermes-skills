...
- **צורית (Tzurit) vs צוריאל (Surial) CONFUSION:** NEVER rely on Hebrew auto-correction for location lookup. User's location is צורית at exact coordinates **32.902, 35.247**. Similar-sounding place names have triggered wrong-data errors twice. Always use coordinates as primary input, never trust Hebrew name matching for Tzurit/צורית.
