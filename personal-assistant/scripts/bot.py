...
📬 <b>תזכורות משימות אוטומטיות</b>
אני שולח את רשימת המשימות הפתוחות כל 4 שעות בין 06:00 ל-22:00.
אפשר לשנות:
• "תזכיר לי על המשימות ב-8 וב-20" — שעות ספציפיות
• "תזכיר לי על המשימות כל שעתיים" — תדירות אחרת
• "אל תזכיר לי על המשימות היום" — השהיה להיום"""
